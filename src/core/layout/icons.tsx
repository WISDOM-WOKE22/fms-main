...
export function IconGrid({ className }: { className?: string }) {
  return (
    <svg className={className ?? svgClass} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function IconCar({ className }: { className?: string }) {
  return (
    <svg className={className ?? svgClass} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M14 16H9m10 0h1v-3a2 2 0 0 0-2-2h-1M5 16H4v-3a2 2 0 0 1 2-2h1" />
      <path d="M5 16v2a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-2" />
      <path d="M5 11V7l2-4h10l2 4v4" />
    </svg>
  );
}

export function IconBarcode({ className }: { className?: string }) {
  return (
    <svg className={className ?? svgClass} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 5v14M7 5v14M11 5v14M15 5v14M19 5v14M5 3h2M5 19h2M11 3h2M11 19h2M17 3h2M17 19h2M9 3v4M9 17v4M15 3v4M15 17v4" />
    </svg>
  );
}
...
export function IconGate({ className }: { className?: string }) {
  return (
    <svg className={className ?? svgClass} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M4 12h16M9 20v-8M15 20v-8" />
    </svg>
  );
}
...
export function IconPlus({ className }: { className?: string }) {
  return (
    <svg className={className ?? svgClass} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
/** Vertical ellipsis — row / card overflow menu */
export function IconEllipsisVertical({ className }: { className?: string }) {
  return (
...
/** Clipboard with checkmark — for audit logs / compliance review */
...
/** Download / export — arrow down to line */
